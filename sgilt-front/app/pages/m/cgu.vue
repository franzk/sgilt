  ...
  <div class="cgu">
    ...
    <div class="wrap layout">
      <nav class="toc" aria-label="Sommaire">
        ...
        <ol>
          <li><a href="#objet">Objet et rôle de Sgilt</a></li>
          <li><a href="#acces">Accès au service</a></li>
          <li><a href="#obligations">Obligations de l'utilisateur</a></li>
          <li><a href="#prestataires">Dispositions — prestataires</a></li>
          <li><a href="#organisateurs">Dispositions — organisateurs</a></li>
          <li><a href="#responsabilite">Responsabilité de Sgilt</a></li>
          <li><a href="#litiges">Litiges entre utilisateurs</a></li>
          <li><a href="#moderation">Modération et accès</a></li>
          <li><a href="#comptes">Comptes et suppression</a></li>
      ...
      <article>
        ...
        <section id="obligations" class="block">
          <h2><span class="num">03</span> Obligations de l'utilisateur</h2>
        ...
        <section id="responsabilite" class="block">
          ...
          <ul>
            ...
            <li>des litiges entre organisateurs et prestataires&nbsp;;</li>
            <li>du contenu publié par les prestataires&nbsp;;</li>
...
useHead({ title: "Conditions générales d'utilisation" })
</script>
