...
export const MOCK_PROVIDERS: PrestataireDetail[] = [
...

  {
    ...
    photos: [
      '/images/prestataires/dj-animation-2.jpg',
      '/images/prestataires/dj-animation-3.jpg',
      '/images/prestataires/dj-animation-4.jpg',
...

  {
    ...
    photos: [
      '/images/prestataires/jazz-band-2.jpg',
      '/images/prestataires/jazz-band-3.jpg',
      'https://images.unsplash.com/photo-1415201364774-f6f0bb35f28f?w=800&q=85',
...

  {
    ...
    photos: [
      'https://images.unsplash.com/photo-1501386761578-eaa54b665f03?w=800&q=85',
      'https://images.unsplash.com/photo-1524368535928-5b5e00ddc76b?w=800&q=85',
      'https://images.unsplash.com/photo-1508700115892-45ecd05ae2ad?w=800&q=85',
    ],
...

  {
    ...
    photos: [
      'https://images.unsplash.com/photo-1598387993441-a364f854cfba?w=800&q=85',
      'https://images.unsplash.com/photo-1511671782779-c97d3d27a1d4?w=800&q=85',
      'https://images.unsplash.com/photo-1540039155733-5bb30b99f9b2?w=800&q=85',
    ],
...

  {
    ...
    photos: [
      ...
      'https://images.unsplash.com/photo-1467003909585-2f8a72700288?w=800&q=85',
    ],
...

  {
    ...
    photos: [
      ...
      'https://images.unsplash.com/photo-1550547660-d9450f859349?w=800&q=85',
      'https://images.unsplash.com/photo-1594212699903-ec8a3eca50f5?w=800&q=85',
    ],
...

  {
    ...
    photos: [
      'https://images.unsplash.com/photo-1514362545857-3bc16c4c7d1b?w=800&q=85',
      'https://images.unsplash.com/photo-1572116469696-31de0f17cc34?w=800&q=85',
      'https://images.unsplash.com/photo-1551538827-9c037cb4f32a?w=800&q=85',
    ],
...

  {
    ...
    photos: [
      ...
      'https://images.unsplash.com/photo-1600891964092-4316c288032e?w=800&q=85',
    ],
...

  {
    ...
    photos: [
      ...
      'https://images.unsplash.com/photo-1571407970349-bc81e7e96d47?w=800&q=85',
...

  {
    ...
    photos: [
      ...
      'https://images.unsplash.com/photo-1519741347686-c1e0aadf4611?w=800&q=85',
    ],
...

  {
    ...
    photos: [
      'https://images.unsplash.com/photo-1527529482837-4698179dc6ce?w=800&q=85',
...

  {
    ...
    photos: [
      ...
      'https://images.unsplash.com/photo-1452780212940-6f5c0d14d848?w=800&q=85',
    ],
...

  {
    ...
    photos: [
      'https://images.unsplash.com/photo-1519167758481-83f550bb49b3?w=800&q=85',
      'https://images.unsplash.com/photo-1464366400600-7168b8af9bc3?w=800&q=85',
      'https://images.unsplash.com/photo-1510798831971-661eb04b3739?w=800&q=85',
    ],
...

  {
    ...
    photos: [
      ...
      'https://images.unsplash.com/photo-1587974928442-77dc3e0dba72?w=800&q=85',
    ],
